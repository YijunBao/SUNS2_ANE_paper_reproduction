...
python train_CNN_params_vary_CNN_data_CNMFE_crop.py 5 25 3 TUnCaT 0
...
python test_batch_vary_CNN_data_CNMFE_crop.py 5 25 3 TUnCaT 0


@REM Training on PFC4_15Hz
python train_CNN_params_vary_CNN_data_CNMFE_crop.py 4 25 3 TUnCaT 1

@REM Testing on PFC4_15Hz
python test_batch_vary_CNN_data_CNMFE_crop.py 4 25 3 TUnCaT 1


@REM Training on bma22_epm
python train_CNN_params_vary_CNN_data_CNMFE_crop.py 4 25 3 TUnCaT 2

@REM Testing on bma22_epm
python test_batch_vary_CNN_data_CNMFE_crop.py 4 25 3 TUnCaT 2
