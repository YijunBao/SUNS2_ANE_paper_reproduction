...
python train_CNN_data_CNMFE_crop.py 2 0 0 FISSA 1
python train_params_data_CNMFE_crop.py 2 0 3 FISSA 1
...
python train_CNN_data_CNMFE_crop.py 2 0 0 FISSA 2
python train_params_data_CNMFE_crop.py 2 0 3 FISSA 2
...
python train_CNN_data_CNMFE_crop.py 2 0 0 FISSA 3
python train_params_data_CNMFE_crop.py 2 0 3 FISSA 3
