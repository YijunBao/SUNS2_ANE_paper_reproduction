...
@REM Training
python train_CNN_data_TENASPIS.py 2 0 0 FISSA
python train_params_data_TENASPIS.py 2 0 3 FISSA
python train_params_data_TENASPIS.py 2 0 7 FISSA
...
@REM Testing
python test_batch_data_TENASPIS.py 2 0 7 FISSA
