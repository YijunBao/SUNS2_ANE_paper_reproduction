...
@REM Training
python train_CNN_data_TENASPIS.py 5 0 0 TUnCaT
python train_params_data_TENASPIS.py 5 0 3 TUnCaT
python train_params_data_TENASPIS.py 5 0 7 TUnCaT
...
@REM Testing
python test_batch_data_TENASPIS.py 5 0 7 TUnCaT
