...
if __name__ == '__main__':
    ...
    nn = 6000 # number of frames used for preprocessing. 
    ...
    list_thred_ratio = list(range(2,8)) # [thred_std] # A list of SNR threshold used to determine when neurons are active.
    filename_TF_template = os.path.join(dir_video, '1P_spike_tempolate.h5')
    ...
    num_total = nn - Poisson_filt.size + 1 # 1500 # 
    ...
    list_minArea = list(range(10,42,5)) 
    # average area of a typical neuron (unit: pixels in ABO videos)
    list_avgArea = [36] # added_refined_masks # [40] # original_masks
    ...
    list_thresh_COM = list(np.arange(2.5, 5, 0.5)) 
