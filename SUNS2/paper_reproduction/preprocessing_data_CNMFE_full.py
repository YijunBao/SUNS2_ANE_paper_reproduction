...
if __name__ == '__main__':
    ...
    list_rate_hz = [10,15,15,5] # 
    # list_decay_time = [0.4, 0.5, 0.4, 0.75]
    list_Dimens = [(120,120),(80,80), (88,88),(192,240)]
    ...
    for ind_video in range(4): #
        ...
        Dimens = list_Dimens[ind_video] # lateral dimensions of the video
        ...
        filename_TF_template = os.path.join(dir_video, Exp_ID+'_spike_tempolate.h5')
        ...
        # list_avgArea = [100] # list(range(30,58,5)) # 
        # # uint8 threshould of probablity map (uint8 variable, = float probablity * 256 - 1)
        # # list_thresh_pmap = list(range(40,156,10))
