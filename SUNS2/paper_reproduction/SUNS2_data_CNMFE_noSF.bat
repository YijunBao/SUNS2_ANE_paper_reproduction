...
python train_CNN_params_data_CNMFE_crop.py 2 0 3 TUnCaT 0
...
python train_CNN_params_data_CNMFE_crop.py 2 0 3 TUnCaT 1
...
python train_CNN_params_data_CNMFE_crop.py 2 0 3 TUnCaT 2
...
python train_CNN_params_data_CNMFE_crop.py 2 0 3 TUnCaT 3
