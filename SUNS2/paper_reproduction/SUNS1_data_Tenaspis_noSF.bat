...
python train_CNN_data_TENASPIS.py 3 0 0 FISSA
python train_params_data_TENASPIS.py 3 0 3 FISSA
python train_params_data_TENASPIS.py 3 0 7 FISSA
...
@REM Run SUNS batch
python test_batch_data_TENASPIS.py 3 0 7 FISSA
