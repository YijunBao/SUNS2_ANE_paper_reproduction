...
python train_CNN_params_vary_CNN_data_TENASPIS.py 3 0 3 FISSA
python train_CNN_params_vary_CNN_data_TENASPIS_continue.py 3 0 7 FISSA
...
@REM Run SUNS batch
python test_batch_vary_CNN_data_TENASPIS.py 3 0 7 FISSA
