...
python train_CNN_params_vary_CNN_data_CNMFE_crop.py 3 25 3 FISSA 0
...
python test_batch_vary_CNN_data_CNMFE_crop.py 3 25 3 FISSA 0


@REM Training on PFC4_15Hz
python train_CNN_params_vary_CNN_data_CNMFE_crop.py 2 25 3 FISSA 1

@REM Testing on PFC4_15Hz
python test_batch_vary_CNN_data_CNMFE_crop.py 2 25 3 FISSA 1


@REM Training on bma22_epm
python train_CNN_params_vary_CNN_data_CNMFE_crop.py 2 25 3 FISSA 2

@REM Testing on bma22_epm
python test_batch_vary_CNN_data_CNMFE_crop.py 2 25 3 FISSA 2


@REM Training on CaMKII_120_TMT
python train_CNN_params_vary_CNN_data_CNMFE_crop.py 2 50 3 FISSA 3

@REM Testing on CaMKII_120_TMT
python test_batch_vary_CNN_data_CNMFE_crop.py 2 50 3 FISSA 3
