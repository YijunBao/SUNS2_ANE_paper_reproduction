...
python train_CNN_params_data_CNMFE_crop.py 3 25 3 FISSA 0
...
python train_CNN_params_data_CNMFE_crop.py 2 25 3 FISSA 1
...
python train_CNN_params_data_CNMFE_crop.py 2 25 3 FISSA 2
...
python train_CNN_params_data_CNMFE_crop.py 2 50 3 FISSA 3
