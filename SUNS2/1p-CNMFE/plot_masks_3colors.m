...
dir_video_SNR = [dir_video,'complete_FISSA\network_input\'];
...
%% SUNS 
dir_output_mask = [dir_video,'complete_FISSA\test_CNN\4816[1]th4\output_masks\Output_Masks_'];
...
if save_figures
    saveas(gcf, [Exp_ID,' Masks SUNS_FISSA.png']);
