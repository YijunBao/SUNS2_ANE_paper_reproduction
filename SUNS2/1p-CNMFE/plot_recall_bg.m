...
save(['recall_sigma_bg ',data_name,' ',num2str(threshJ),'.mat'],'NGT_PSNR','N_PSNR');
% %%
...
saveas(gcf,['Recall vs sigma_bg ',data_name,' ',num2str(threshJ),'.png'])
...
saveas(gcf,['GT Number vs sigma_bg ',data_name,' ',num2str(threshJ),'.png'])
