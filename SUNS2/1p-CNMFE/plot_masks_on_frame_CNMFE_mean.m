...
rectangle('Position',rect1_sub,'EdgeColor',color(7,:),'LineWidth',2);
rectangle('Position',rect2_sub,'EdgeColor',color(7,:),'LineWidth',2);
rectangle('Position',rect3_sub,'EdgeColor',color(7,:),'LineWidth',2);
