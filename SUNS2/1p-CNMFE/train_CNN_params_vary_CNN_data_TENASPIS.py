...
if __name__ == '__main__':
    ...
    dir_parent = dir_video + 'complete_TUnCaT_SF{}\\'.format(gauss_filt_size) # folder to save all the processed data
    ...
    filename_TF_template = dir_video + 'TENASPIS_spike_tempolate.h5'
    ...
    #     # %% Determine active neurons in all frames using SUNS
