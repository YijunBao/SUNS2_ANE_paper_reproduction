...
if __name__ == '__main__':
    ...
    sub_folder = sys.argv[6] # + '_2out' # '+BGlayer' 
    ...
    dir_parent = dir_video + 'complete_FISSA\\' # folder to save all the processed data
    dir_sub = '\\test_CNN\\' + sub_folder + '\\'
    weights_path = dir_parent + dir_sub + 'Weights\\' # folder to save the trained CNN
    dir_output = dir_parent + dir_sub + 'output_masks pmap\\' # folder to save the segmented masks and the performance scores
    ...
    for CV in list_CV:
        ...
        Masks, Masks_2, times_active, time_total, time_frame, pmaps_b = suns_batch(
        ...
        savemat(dir_output+'Output_Masks_{}.mat'.format(Exp_ID), {'Masks':Masks, 'times_active':times_active, 'pmaps_b': pmaps_b}, do_compression=True)
