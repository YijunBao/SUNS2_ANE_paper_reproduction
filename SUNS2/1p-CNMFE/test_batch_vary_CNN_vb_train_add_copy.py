...
if __name__ == '__main__':
    ...
    sub_added = sys.argv[7] # sub folder for added neurons
    ...
    dir_video = os.path.join('E:\\data_CNMFE', name_video+'_original_masks')
    ...
    dir_parent = os.path.join(dir_video, 'complete_TUnCaT_train_from_real_fake') # folder to save all the processed data
    dir_parent_train = os.path.join(dir_train, 'complete_TUnCaT') # folder to save all the processed data
    dir_sub = sub_folder
