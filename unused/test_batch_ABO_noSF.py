...
if __name__ == '__main__':
    ...
    dir_parent = dir_video + 'TUnCaT_noSF\\' # folder to save all the processed data
    ...
    for CV in list_CV:
        ...
        Masks, Masks_2, times_active, time_total, time_frame = suns_batch(
            ...
            useSF=useSF, useTF=useTF, useSNR=useSNR, useWT=useWT, prealloc=prealloc, display=display, p=p, fff=fff)
