...
if __name__ == '__main__':
    ...
    dir_output = dir_parent + 'output_masks gc_p=None39\\' # folder to save the optimized hyper-parameters
    dir_temp = dir_parent + 'temp gc_p=None39\\' # temporary folder to save the F1 with various hyper-parameters
