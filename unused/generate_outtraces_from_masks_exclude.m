function bgtraces=generate_outtraces_from_masks_exclude(video,masks)
...
for nn=1:ncells
    ...
    circleout_exclude = circleout & outside;
    bgtraces(nn,:)=mean(video(circleout_exclude(:),:),1);
end
