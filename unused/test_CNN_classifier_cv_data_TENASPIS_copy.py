...
if __name__ == "__main__":
    ...
    dir_parent=r'D:\data_TENASPIS\original_masks'
    ...
    dir_CNN = os.path.join(dir_parent, 'GT Masks dropout {}/add_new_blockwise_weighted_sum_unmask\classifiers_avg_Xmask\classifier_res0_0+1 frames'.format(drop_rate))
