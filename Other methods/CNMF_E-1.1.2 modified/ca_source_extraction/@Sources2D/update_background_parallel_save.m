function output_bg_info = update_background_parallel_save(obj, use_parallel)
% function update_background_parallel_save(obj, use_parallel)
...
output_bg_info = struct('Y',Y, 'A',A, 'C',C, 'b',b, 'f',f, 'b0',b0, ...
    'W',W, 'patch_pos',patch_pos ,'block_pos',block_pos);
% output_bg_info = struct();
% output_bg_info.Y = Y;
% output_bg_info.A = A;
% output_bg_info.C = C;
% output_bg_info.b = b;
% output_bg_info.f = f;
% output_bg_info.b0 = b0;
% output_bg_info.W = W;
% output_bg_info.patch_pos = patch_pos;
% output_bg_info.block_pos = block_pos;
