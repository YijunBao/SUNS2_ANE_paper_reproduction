...
python convert_h5_tiff_scale_data_CNMFE.py

@REM Run DeepWonder
python script_data_CNMFE_scale.py 128

@REM Postprocess the DeepWonder result
matlab -nojvm -nodesktop -r "patch_size = 128; DeepWonder_postprocessing_data_CNMFE_scale; exit"
