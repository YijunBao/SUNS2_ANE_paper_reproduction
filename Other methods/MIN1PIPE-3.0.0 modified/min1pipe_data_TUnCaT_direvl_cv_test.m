...
%         Masks3 = reshape(full(roib), saved_result.pixh, saved_result.pixw, size(roib,2));
        save(fullfile(dir_save,dir_sub,[Exp_ID,'_Masks_',num2str(thb),'.mat']),'Masks3','traces');
        save(fullfile(dir_save,dir_sub_save,[Exp_ID,'_Masks.mat']),'Masks3','traces');
