...
load('EXTRACT/eval.mat')
% radii = [4:8];
% SNRs = [3:4:23];
output_folder = ['./EXTRACT_CV/'];
...
save([output_folder,'CV_times_test.mat'], 'CV_times');
save(fullfile(output_folder,'eval_CV.mat'), 'list_Recall', 'list_Precision', ...
