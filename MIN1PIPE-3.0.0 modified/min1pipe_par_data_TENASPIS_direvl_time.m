...
%                         end
                    ...
                    %% Calculate accuracy
                    saved_result = load(fname, 'process_time');
                    for tid = 1:num_thb
...
%                         parsave1(fullfile(dir_save,dir_sub,[Exp_ID,'_Masks_',num2str(thb),'.mat']),Masks3,'Masks3');
                        saved_masks = load(fullfile(dir_save,dir_sub,[Exp_ID,'_Masks_',num2str(thb),'.mat']),'Masks3');
                        Masks3 = saved_masks.Masks3;
...
%                         'list_pss','list_psc','list_mrc','list_thb')
                ...
                new_history = [temp_param', thb, mean(Table_time,1), max(Table_time(:,end),[],1)];
