function [file_name_to_save, filename_raw, filename_reg] = min1pipe_h5(path_name, filename, Fsi, Fsi_new, spatialr, se, ismc, flag)
% main_processing
...
%     [path_name, file_base, file_fmt] = data_info;
    ...
    for i = 1: length(file_base)
        ...
        filecur = [path_name, folder, file_base{i}, '_data_processed.mat'];
        ...
        if overwrite_flag
            ...
            %%% --------- 2nd section ---------- %%%
            filename_reg = [path_name, folder, file_base{i}, '_reg.mat'];
...
%                     end
            ...
            %%% --------- 3rd section ---------- %%%
            nflag = 2;
            filename_reg_post = [path_name, folder, file_base{i}, '_reg_post.mat'];
...
%             dff = compute_dff(sigfn, bgfn, bgffn, seedsfn);
            ...
            file_name_to_save = [path_name, folder, file_base{i}, '_data_processed.mat'];
            if exist(file_name_to_save, 'file')
%                 if ismc
...
%                 end
            ...
            filename_raw = [path_name, folder, file_base{i}, '_frame_all.mat'];
            filename_reg = [path_name, folder, file_base{i}, '_reg.mat'];
