...
if __name__ == "__main__":
    ...
    dir_video = 'D:\\data_TENASPIS\\added_refined_masks\\GT Masks dropout {}\\add_new_blockwise{}'.format(drop_rate, folder_sub)
    # dir_video = 'D:\\data_TENASPIS\\original_masks\\GT Masks dropout {}\\add_new_blockwise{}'.format(drop_rate, folder_sub)
