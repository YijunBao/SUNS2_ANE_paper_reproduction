...
if __name__ == "__main__":
    sys.argv = ['.py', 'classifier_res0', '0', 'Xmask', '0', '1', '_weighted_sum_unmask', '0.8exp(-10)', 'lowBG=5e+03,poisson=1']
    ...
    dir_video = os.path.join('E:\\simulation_CNMFE_corr_noise', name_video, 
        'GT Masks dropout {}\\add_new_blockwise{}'.format(drop_rate, folder_sub))
    ...
    y_train = np.concatenate([y for (i, y) in enumerate(list_y_train)])
