...
%     dir_parent = fullfile('E:\data_CNMFE',[data_name,'_original_masks']);
    ...
    dir_video = fullfile(dir_parent, ['add_neurons_',num2str(neuron_amp),'_rotate']); % ,'_lowoverlap'
...
%     load(fullfile(dir_add_new,[Exp_ID,'_weights_blockwise.mat']),'masks');
    ...
    load(fullfile(dir_GT_info, ['GT_', Exp_ID, '_added.mat']), 'masks', 'masks_add');
    masks_add_GT = masks_add;
