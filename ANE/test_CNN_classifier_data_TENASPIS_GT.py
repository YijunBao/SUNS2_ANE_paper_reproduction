    ...
    for opt_th_cnn in list_opt_th_cnn:
        for version in [0]: # range(2,9): # range(0,10): # 
            ...
            for th_SNR in [4]: # range(3,6):
                list_dir_test = []
                # list_dir_test.append('D:\\data_TENASPIS\\original_masks\\GT Masks\\add_new_blockwise{}'.format(folder_sub))
                list_dir_test.append('D:\\data_TENASPIS\\added_refined_masks\\GT Masks\\add_new_blockwise{}'.format(folder_sub))
