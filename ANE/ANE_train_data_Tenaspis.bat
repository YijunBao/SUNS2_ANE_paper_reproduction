...
matlab -nojvm -nodesktop -r "clustering_mm_GT_drop_data_TENASPIS; exit"

@REM Determine true or false neurons by matching to dropped out GT neurons
matlab -nojvm -nodesktop -r "match_GT_drop_data_TENASPIS; exit"

@REM Train CNN discriminator
python train_CNN_classifier_cv_drop_data_TENASPIS.py
