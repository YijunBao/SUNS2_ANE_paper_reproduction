...
if __name__ == "__main__":
    ...
    for opt_th_cnn in list_opt_th_cnn:
        for version in [0]: # range(2,9): # range(0,10): # 
            ...
            dir_parent = 'E:\\data_CNMFE\\{}'.format(name_video)
            # dir_parent = os.path.join('E:\\data_CNMFE\\{}_added_blockwise_weighted_sum_unmask'.format(name_video)
            ...
            for th_SNR in [5]: # range(3,6):
                list_dir_test = [os.path.join(dir_parent, 'complete_TUnCaT_SF25\\4816[1]th{}\\output_masks\\add_new_blockwise{}'.format(th_SNR, folder_sub))]
