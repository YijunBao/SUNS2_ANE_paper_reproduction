...
dir_traces_raw=fullfile(dir_video,['SUNS_TUnCaT_SF',num2str(list_SF(data_ind))],'TUnCaT','raw');
dir_traces_unmix=fullfile(dir_video,['SUNS_TUnCaT_SF',num2str(list_SF(data_ind))],'TUnCaT','alpha= 1.000');
doesunmix = 1;
