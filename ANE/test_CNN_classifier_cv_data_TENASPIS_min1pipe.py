    ...
    for opt_th_cnn in list_opt_th_cnn:
        for version in [0]: # range(2,9): # range(0,10): # 
            ...
            for th_SNR in [4]: # range(3,6):
                ...
                dir_save = os.path.join(dir_parent,'CNMFE')
                # save_date = '20230111'
                # dir_sub_save = 'cv_save_'+save_date
                # dir_save = os.path.join(dir_parent,'min1pipe')

                dir_masks = os.path.join(dir_save,dir_sub_save) 
                dir_add_new = os.path.join(dir_masks, 'add_new_blockwise_weighted_sum_unmask')

                list_dir_test = []
                list_dir_test.append(dir_add_new)
