...
list_Exp_ID = list_data_names(data_ind);
...
dir_parent='E:\data_CNMFE\full videos';
...
%     masks_sum = sum(masks,3);
    ...
    for iy = 1:npatchy
        ...
        [image_new_crop, mask_new_crop, mask_new_full, select_frames_class, select_weight_calss] = ...
            find_missing_multi_frame_blockwise_weighted_sum(video, masks, xmin, xmax, ymin, ymax, ...
