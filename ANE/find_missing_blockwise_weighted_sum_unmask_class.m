function [image_new_crop, mask_new_crop, mask_new_full, select_frames_class, ...
    select_weight_calss, classes, video_sub_sort, mask_update_select, select_frames_sort_full] = ...
