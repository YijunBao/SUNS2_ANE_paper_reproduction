...
# data_ind = 1; dir_SUNS_sub = os.path.join('SUNS_FISSA_SF25','4816[1]th3');
data_ind = 3 
dir_SUNS_sub = os.path.join('SUNS_TUnCaT_SF50','4816[1]th4')
# data_ind = 2; dir_SUNS_sub = os.path.join('SUNS_FISSA_SF25','4816[1]th2');
# data_ind = 3; dir_SUNS_sub = os.path.join('SUNS_FISSA_SF25','4816[1]th2');
# data_ind = 4; dir_SUNS_sub = os.path.join('SUNS_FISSA_SF50','4816[1]th2');
##
if __name__ == "__main__":
    ...
    for eid in range(num_Exp):
        ...
        time_weights = added_auto_blockwise['time_weights']
        ...
        try:
            ...
            pred_valid = CNN_predict['pred_valid']
            time_CNN = CNN_predict['time_CNN']
            ...
            list_added_final = list_added_sparse_final.A.reshape((-1,Ly,Lx))
            ##
        ...
        sio.savemat(os.path.join(dir_add_new,folder,'Output_Masks_'+Exp_ID+'_added.mat'),{'Masks':Masks.transpose([2,1,0])})
        ...
        DroppedMasks = DroppedMasks['DroppedMasks'].transpose([2,1,0])
    ...
    Table_ext = np.concatenate([Table, np.nanmean(Table,1, keepdims=True), np.nanstd(Table, 1, ddof=1, keepdims=True)], 0)
    print(Table_ext[:-1, 2:])
