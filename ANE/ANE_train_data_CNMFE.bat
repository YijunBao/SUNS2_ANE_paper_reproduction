...
matlab -nojvm -nodesktop -r dropout_GTMasks_data_CNMFE
...
matlab -nojvm -nodesktop -r pre_CNN_data_CNMFE_drop_GT_blockwise_weighted_sum_mm

@REM Determine true or false neurons by matching to dropped out GT neurons
matlab -nojvm -nodesktop -r post_GUI_data_CNMFE_drop_GT_blockwise

@REM Train CNN discriminator
python train_CNN_classifier_data_CNMFE_blockwise_cv_drop.py 0.8exp(-8)
