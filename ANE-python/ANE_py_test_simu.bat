...
python clustering_mm_SUNS_simu.py "SUNS_TUnCaT_SF25/4816[1]th4/output_masks" lowBG=5e+03,poisson=1

@REM Apply CNN discriminator to determine whether each putative missing neuron is valid
python test_CNN_classifier_cv_simu_py.py "SUNS_TUnCaT_SF25/4816[1]th4/output_masks" lowBG=5e+03,poisson=1

@REM Add valid missing neurons to output neurons
python post_CNN_cv_simu.py "SUNS_TUnCaT_SF25/4816[1]th4/output_masks" lowBG=5e+03,poisson=1
