...
method = 'min1pipe'; % 'CNMFE'; % 
% list_thred_ratio = 8;
if contains(method,'CNMFE')
    dir_traces = fullfile(dir_video,'CNMFE\cv_save_20230715');
else
    dir_traces = fullfile(dir_video,'min1pipe\cv_save_20230716');
end
...
dir_traces_out = fullfile(dir_traces, 'TUnCaT/raw');
...
%             list_alpha = 1; %
            ...
            for ii = 1:num_Exp
                ...
                load(fullfile(dir_traces,[Exp_ID,'_Masks.mat']),'Masks3','traces');
%                 Masks3 = Masks;
