...
for data_ind = 1:4
    ...
    if data_ind == 3
        saveas(gcf,['Fig4S-3D - F1 speed ',data_name(1:end-7),' 0320.emf']);
        saveas(gcf,['Fig4S-3D - F1 speed ',data_name(1:end-7),' 0320.png']);
    end
end
...
for data_ind = 1:4
    ...
    saveas(gcf,['Fig4S-2B-',num2str(data_ind),' - F1 speed ',data_name(1:end-7),' noSF 0320.emf']);
    saveas(gcf,['Fig4S-2B-',num2str(data_ind),' - F1 speed ',data_name(1:end-7),' noSF 0320.png']);
end
...
% saveas(gcf,['F1 speed ',data_name(1:end-1),'7.emf']);
% saveas(gcf,['F1 speed ',data_name(1:end-1),'7.png']);
saveas(gcf,['Fig3S-4B - F1 speed ',data_name,'.emf']);
saveas(gcf,['Fig3S-4B - F1 speed ',data_name,'.png']);
...
% saveas(gcf,['F1 speed ',data_name(1:end-1),'7.emf']);
% saveas(gcf,['F1 speed ',data_name(1:end-1),'7.png']);
saveas(gcf,['Fig3S-3B - F1 speed ',data_name,'.emf']);
saveas(gcf,['Fig3S-3B - F1 speed ',data_name,'.png']);
...
% saveas(gcf,['F1 speed ',data_name(1:end-1),'7.emf']);
% saveas(gcf,['F1 speed ',data_name(1:end-1),'7.png']);
saveas(gcf,['Fig3S-2B - F1 speed ',data_name(1:end-8),' noSF.emf']);
saveas(gcf,['Fig3S-2B - F1 speed ',data_name(1:end-8),' noSF.png']);
