...
for data_ind = 1:4
    ...
    saveas(gcf,['Fig4D ',num2str(data_ind),'- F1 speed ',data_name(1:end-7),' 0320.emf']);
    saveas(gcf,['Fig4D ',num2str(data_ind),'- F1 speed ',data_name(1:end-7),' 0320.png']);
    if data_ind == 3
        saveas(gcf,['FigS11D - F1 speed ',data_name(1:end-7),' 0320.emf']);
        saveas(gcf,['FigS11D - F1 speed ',data_name(1:end-7),' 0320.png']);
    end
end
...
for data_ind = 1:4
    ...
    saveas(gcf,['FigS10B-',num2str(data_ind),' - F1 speed ',data_name(1:end-7),' noSF 0320.emf']);
    saveas(gcf,['FigS10B-',num2str(data_ind),' - F1 speed ',data_name(1:end-7),' noSF 0320.png']);
end
...
for data_ind = 1:4
    ...
    % saveas(gcf,['F1 speed ',data_name(1:end-7),' noSF',data_name(end-4:end),'.emf']);
    % saveas(gcf,['F1 speed ',data_name(1:end-7),' noSF',data_name(end-4:end),'.png']);
    saveas(gcf,['F1 speed ',data_name(1:end-7),' DeepWonder 0407.emf']);
    saveas(gcf,['F1 speed ',data_name(1:end-7),' DeepWonder 0407.png']);
end
...
% saveas(gcf,['F1 speed ',data_name(1:end-1),'7.emf']);
% saveas(gcf,['F1 speed ',data_name(1:end-1),'7.png']);
saveas(gcf,['F1 speed ',data_name,' DeepWonder.emf']);
saveas(gcf,['F1 speed ',data_name,' DeepWonder.png']);
...
% saveas(gcf,['F1 speed ',data_name(1:end-1),'7.emf']);
% saveas(gcf,['F1 speed ',data_name(1:end-1),'7.png']);
saveas(gcf,['FigS8B - F1 speed ',data_name,'.emf']);
saveas(gcf,['FigS8B - F1 speed ',data_name,'.png']);
...
% saveas(gcf,['F1 speed ',data_name(1:end-1),'7.emf']);
% saveas(gcf,['F1 speed ',data_name(1:end-1),'7.png']);
saveas(gcf,['FigS7B - F1 speed ',data_name,'.emf']);
saveas(gcf,['FigS7B - F1 speed ',data_name,'.png']);
...
% saveas(gcf,['F1 speed ',data_name(1:end-1),'7.emf']);
% saveas(gcf,['F1 speed ',data_name(1:end-1),'7.png']);
saveas(gcf,['FigS6B - F1 speed ',data_name(1:end-8),' noSF.emf']);
saveas(gcf,['FigS6B - F1 speed ',data_name(1:end-8),' noSF.png']);
