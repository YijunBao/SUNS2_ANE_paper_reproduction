...
box off
% set(gca,'Position',two_errorbar_position);
saveas(gcf,['FigS2C - Scores ',data_name,' ANE.emf']);
saveas(gcf,['FigS2C - Scores ',data_name,' ANE.png']);
...
legend(list_method,'Location','NorthOutside','NumColumns',5,'FontSize',14); % 
...
saveas(gcf,'FigS2D - F1_simu_lowpassBG_all.emf')
saveas(gcf,'FigS2D - F1_simu_lowpassBG_all.png')
...
box off
% set(gca,'Position',two_errorbar_position);
saveas(gcf,['Fig4A - Scores ',data_name(1:end-8),' noSF.emf']);
saveas(gcf,['Fig4A - Scores ',data_name(1:end-8),' noSF.png']);


%% Figure 4C:
% Comparing Recall, Precision, and F1 of different segmentation methods with ANE for TENASPIS dataset.
data_name = 'TENASPIS_ANE_4 0425'; % 
load(['F1 speed ',data_name,'.mat'],'Recall','Precision','F1','Speed','list_method');
% list_method = {'MIN1PIPE','CNMF-E','SUNS1','SUNS2','SUNS2-ANE'};  % ,'SUNS2 (no SF)'
...
box off
% set(gca,'Position',two_errorbar_position);
saveas(gcf,['Fig4E - F1 TENASPIS ANE all.emf']);
saveas(gcf,['Fig4E - F1 TENASPIS ANE all.png']);
...
box off
% set(gca,'Position',two_errorbar_position);
saveas(gcf,['Fig4H - F1 TENASPIS original vs refined.emf']);
saveas(gcf,['Fig4H - F1 TENASPIS original vs refined.png']);
...
box off
set(gca,'Position',two_errorbar_position);
saveas(gcf,['FigS4C - Scores ',data_name,' DeepWonder.emf']);
saveas(gcf,['FigS4C - Scores ',data_name,' DeepWonder.png']);
...
for data_ind = 1:4
    ...
    saveas(gcf,['Fig5C-',num2str(data_ind),' - Scores ',data_name(1:end-7),'.emf']);
    saveas(gcf,['Fig5C-',num2str(data_ind),' - Scores ',data_name(1:end-7),'.png']);
%     if data_ind == 3
...
for data_ind = 1:4
    ...
    % saveas(gcf,['Scores ',data_name(1:end-7),data_name(end-4:end),'.emf']);
    % saveas(gcf,['Scores ',data_name(1:end-7),data_name(end-4:end),'.png']);
    saveas(gcf,['FigS4G-',num2str(data_ind),' - Scores ',data_name(1:end-7),' DeepWonder.emf']);
    saveas(gcf,['FigS4G-',num2str(data_ind),' - Scores ',data_name(1:end-7),' DeepWonder.png']);
%     if data_ind == 3
%         saveas(gcf,['FigS11C - Scores ',data_name(1:end-7),' 0315.emf']);
%         saveas(gcf,['FigS11C - Scores ',data_name(1:end-7),' 0315.png']);
%     end
...
for data_ind = 1:4
    ...
    box off
    % set(gca,'Position',two_errorbar_position);
    saveas(gcf,['FigS5C-',num2str(data_ind),' - Scores ',data_name(1:end-7),' noSF.emf']);
    saveas(gcf,['FigS5C-',num2str(data_ind),' - Scores ',data_name(1:end-7),' noSF.png']);
end
