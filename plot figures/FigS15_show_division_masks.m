...
dir_Masks = '../generate_data/crop data_CNMFE/GT Masks updated';
...
for ind= 1:4 % 4 % 
    ...
    load(fullfile(dir_Masks,['FinalMasks_',data_name,'_merge.mat']),'FinalMasks');
