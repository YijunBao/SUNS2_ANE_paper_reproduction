...
saved_date_MIN1PIPE = '20221219 cv';
saved_date_CNMFE = '20221218 cv';
...
%% SUNS + missing finder
dir_output_mask_SUNS = fullfile(dir_video,'complete_TUnCaT_SF25\4816[1]th4\output_masks');
dir_output_mask = fullfile(dir_output_mask_SUNS,'add_new_blockwise_weighted_sum_unmask\trained dropout 0.8exp(-5)\avg_Xmask_0.5\classifier_res0_0+1 frames');
...
%% SUNS TUnCaT
dir_output_mask = fullfile(dir_video,'complete_TUnCaT_SF25\4816[1]th4\output_masks');
% load([dir_output_mask, Exp_ID, '.mat'], 'Masks_2');
% Masks = reshape(full(Masks_2'),487,487,[]);
...
%% SUNS FISSA
dir_output_mask = fullfile(dir_video,'complete_FISSA_SF25\4816[1]th2\output_masks');
% load([dir_output_mask, Exp_ID, '.mat'], 'Masks_2');
% Masks = reshape(full(Masks_2'),487,487,[]);
load(fullfile(dir_output_mask, ['Output_Masks_', Exp_ID, '.mat']), 'Masks');
Masks_SUNS = permute(Masks,[3,2,1]); % FinalMasks; % 
